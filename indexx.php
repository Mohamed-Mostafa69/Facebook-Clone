      ...
      <div class="loginform">
        <table>
          ...
          <form action="index.php" method="POST">
            ...
            <td><input name="password"class="logintext loginrowgap loginfield" type="password"></td>
...
<div class="mobile">
  ...
  <form action="index.php" method="POST">
    <div id="mobtextdiv">
      <input name="email" type="text" class="mobtextbox mobtextbox1" placeholder="Mobile number or email address">
      <input name ="password" type="password" class="mobtextbox mobtextbox2" placeholder="Password">
    </div>
  </form>
